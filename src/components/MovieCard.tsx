      ...
      >
        ...
        {item.poster_path ? (
          ...
          <div className="flex flex-col items-center justify-center w-full h-full text-center p-4 bg-gradient-to-b from-[#181822] to-[#0E0E15] border border-white/5 relative">
            <span className="text-[#EF4444] text-[9px] font-black uppercase tracking-widest mb-1.5 opacity-60">Plexoria</span>
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-20">
          <div className="w-12 h-12 rounded-full bg-[#EF4444] text-white flex items-center justify-center shadow-lg shadow-red-500/35 transform scale-75 group-hover:scale-100 transition-transform duration-300">
        ...
        {year && (parseInt(year) >= 2025) ? (
          <div className="absolute top-2 left-2 z-20 px-1.5 py-0.5 rounded-md bg-[#EF4444] text-[9px] font-bold text-white shadow-md tracking-wider">
            NEW
          </div>
